                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Create Sub Topic</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-6">
                <div class="card">
                    ...
                    <div class="px-4 pb-4">
                        ...
                        <form action="{{url('admin/subtopics')}}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="heading" class="form-control" id="name" placeholder="Enter Name">
                                @error('heading')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="body" class="form-control" id="body" cols="30" rows="10" placeholder="Enter Topic Body"></textarea>
                                @error('body')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
