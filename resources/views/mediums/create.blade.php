        ...
        <div class="row align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Create Medium</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="col-7">
                <div class="text-end upgrade-btn">
                    <a href="{{url('admin/boards')}}" class="btn btn-danger text-white">Medium List</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="card">
                    ...
                    <div class="px-4 pb-4">
                        <h3 class="mb-3">Medium Form</h3>
                        <form action="{{url('admin/mediums')}}" method="POST">
                            @csrf
