...
{{--                                    {{ dd($item->subjects()->first()->standard->medium) }}--}}
                                  ...
                                  <td>All</td>
                                    ...
                                    <td>
                                        <a href="{{url('admin/course/activation', ['course'=>$item->id])}}"><button class="btn btn-sm btn-warning"><span class="mdi mdi-key"></span> Keys [{{$item->activation->count()}}] </button></a>
