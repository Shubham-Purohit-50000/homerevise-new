...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-5">
                <h4 class="page-title">Create Quiz</h4>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="card">
                    ...
                    <div class="px-4 pb-4">
                        <h3 class="mb-3">Quiz Details Form</h3>
                        <form action="{{url('admin/quizes')}}" method="POST">
                            @csrf
                            <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="quiz_type" id="quiz_type" class="form-control" required>
                                    ...
                                    <option value="STWQ">Standard Wise Quiz</option>
                                    <option value="SWQ">Subject Wise Quiz</option>
                                    <option value="CWQ">Chapter Wise Quiz</option>
                                </select>
                                @error('quiz_type')
                            ...
                            <div class="row">
                                <div class="col-sm-12" id="standard" style="display:none;">
                                    <div class="form-group">
                                        <label for="medium">Select Standard</label><br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="quiz_subject" id="quiz_subject" class="form-control  js-example-basic-multiple">
                                            ...
                                            @foreach($subjects as $item)
                                                <option value="{{$item->id}}">{{$item->standard->name}} | {{$item->name}}</option>
                                            @endforeach
                                        </select>                            
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <textarea name="quiz_desc" class="form-control" required></textarea>
                                </div>

                                <div class="form-group d-flex align-items-center ">
                                    <label for="marks" style="margin:0px;">Is Marks Manual?</label>
                                    <div class="form-check form-switch" style="margin-left:20px;">
                                        <input class="form-check-input" type="checkbox" id="marks_type" name="marks_type">
                                    </div>
                                </div>
                                <div class="form-group" id="manual" style="display:none;">
                                    ...
                                    <input class="form-control" type="number" id="manual_marks" name="manual_marks" step="0.01">
                                </div>
                                <div class="form-group d-flex align-items-center ">
                                    <label for="negative_marking_type" style="margin:0px;">Is Negative Marking?</label>
                                    <div class="form-check form-switch" style="margin-left:20px;">
                                        <input class="form-check-input" type="checkbox" id="negative_marking_type" name="negative_marking_type">
                                    </div>
                                </div>
                                <div class="form-group" id="negative" style="display:none;">
                                    ...
                                    <input class="form-control" type="number" id="negative_marking" name="negative_marking" step="0.01">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn btn-success text-white">Save & Next</button>
                            </div>
                        </form>
                    </div>
                </div>
